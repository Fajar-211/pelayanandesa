        ...
        <div class="flex-1  bg-[#DEF2F1] overflow-hidden">
          <div class="bg-[#DEF2F1] flex justify-center w-full ">
            ...
            <div class="w-5/6 hidden mt-10" id="DivKas">
              <!-- Kas Warga -->
              <button class="btn bg-white text-gray-800 hover:bg-gray-200 focus:outline-none" id="buttonKasWarga"
                onclick="showKasWarga()">Kas Warga</button>
            ...
            <div class="w-5/6 hidden" id="DivEdit"><!-- Edit Profile -->
              <form action="">
                ...
                <table>
                  ...
                  <tr>
                    <td><input type="date" placeholder="Type here" class="input w-full max-w-xs bg-[#DEF2F1]" /></td>
                  </tr>
                  <tr></tr>
                  <tr>
                    <td class="text-green-500">Email</td>
