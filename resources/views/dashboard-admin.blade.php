                ...
                <div class="flex-1  bg-[#DEF2F1] overflow-hidden">
                    <div class="bg-[#DEF2F1] flex justify-center w-full ">
                                        ...
                                        <table class="text-black">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" placeholder="Masukkan nama"
                                                        class="mt-5 ml-10 input w-full max-w-xs border-[#e7e7e7]" />
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Upload Foto</td>
                                                <td><input name="file" type="file"
                                                        class="mt-5 ml-10 file-input w-full max-w-xs bg-white" /></td>
                                            </tr>
                                        </table>
                                    </form>
                                </div>
                                ...
                                <form action="{{ route('notif.store') }}" method="post">
                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td><input type="text" id="deskripsi" name="deskripsi"
                                                    placeholder="notifikasi" class="input w-full max-w-xs bg-white"
                                                    required /></td>
                                        </tr>
                                        <tr>
                                            <td><button class="btn btn-accent text-white">Masuk</button></td>
                                            <td></td>
                                        </tr>
                        ...
                        <div class="w-5/6 hidden" id="DivInfo"><!-- Info Porfile -->
                            ...
                            <div class="card-actions justify-end">
                                <button class="btn btn-accent text-white bg-[#0FA4AF]" id="showEdit"
                                            ...
                                            <label for="file-input">
                                                ...
                                                <div class="flex justify-center">
                                                    <input id="file-input" type="file"
                                                        class="file-input w-full max-w-xs bg-white hidden" />
                                                </div>
                                            </label>
                                        </div>
                                        <div class="flex justify-center"><input type="text"
                                                placeholder="{{ $nama }}"
