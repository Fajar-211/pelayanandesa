                            ...
                            <table class="text-black">
                              ...
                              <tr>
                                <td>
                                  ...
                                  <input class="ml-10 input w-full max-w-xs border-[#e7e7e7]" type="number" id="jumlah" name="jumlah" required>
                                </td>
                              </tr>
                              <tr>
                                <td>
                                  <label for="saldo">Saldo Akhir</label>
                                  <input class="ml-10 input w-full max-w-xs border-[#e7e7e7]" type="number" id="saldo" name="saldo" required>
                                </td>
                              </tr>
                            </table> 
                          </form>
                    ...
                    <div class="card text-primary-content">
                      <div class="card-body">
                        ...
                        <table>
                          ...
                          <tr>
                            <td class="text-stone-400">example@gmail.com</td>
                          </tr>
                        </table>
                      </div>
                    </div>
