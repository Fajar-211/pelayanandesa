<x-app-layout>
    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col h-screen">
            ...
            <!-- main content -->
            <div class="flex-1  bg-[#DEF2F1] overflow-y-auto p-4">
                <div class="card bg-white text-black w-full">
                    <div class="card-body">
                      <h2 class="card-title">Global Signature Setting</h2>
                      <form action="{{ route('admin.setting.signature') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <input type="file" class="file-input w-full" name="signature" accept=".jpg">
