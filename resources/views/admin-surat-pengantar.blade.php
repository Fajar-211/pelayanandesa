    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-content flex flex-col h-screen">
            ...
            <div class="header-wrapper bg-[#DEF2F1] px-4 py-2 lg:px-4 lg:py-2">
                <div
                    class="header-box bg-[#DEF2F1] rounded-lg flex justify-between items-center py-4 px-6 lg:px-12"
                >
                    <div class="flex items-center">
                        ...
                        <span
                            class="text-lg lg:text-xl font-semibold ml-10 text-[#2B7A78]"
                            >Hallo,
                            {{ \App\models\User::where('email', Auth::user()->email)->first()->name }}</span
                        >
                    </div>
            ...
            <div class="flex-1 bg-[#DEF2F1] overflow-y-auto">
                <div class="bg-[#DEF2F1] flex justify-center w-full">
                    <div class="w-5/6 mt-10" id="DivSurat">
                        <!-- Surat Pengantar -->
                        <div class="flex items-center space-x-2">
                            <span
                                class="inline-flex items-center justify-center px-4 py-3 text-black bg-white rounded-md"
                                >Permintaan</span
                            >
                        </div>
                        <br />

                        <livewire:admin-surat-pengantar-table/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="drawer-side">
            ...
            <ul class="menu text-white h-full w-80 p-4 bg-[#3AAFA9]">
                ...
                <li>
                    <a href="{{ url('/admin/surat-pengantar') }}"
                        >Surat pengantar</a
                    >
                </li>
                <li><a href="{{ url('/admin/kas-warga') }}">Kas warga</a></li>
                <li>
                    <a href="{{ url('/admin/wajib-lapor') }}">Wajib lapor</a>
                </li>
                <li><a href="{{ url('/admin/data-warga') }}">Data Warga</a></li>
                <li>
                    <a href="{{ url('/admin/pemberitahuan') }}"
                        >Pemberitahuan</a
                    >
                </li>
